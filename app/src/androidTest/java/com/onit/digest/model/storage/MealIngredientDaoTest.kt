...
class MealIngredientDaoTest {
    ...
    private fun prepopulateDatabase() {
        executeSql(
            digestDb,
            "INSERT INTO meal (id,name,is_archived) values (1,'Pasta Bolognese',0), (2,'Thai Curry',0), (3, 'Sausage & Mash',0),(4,'Archived Meal',1)",
    ...
    fun getAllMealsWithIngredients() {
        ...
        mealIngredientDao.getAllMealsWithIngredients().observeForever {
            ...
            assertThat(it[0].ingredients[0].ingredient, `is`(
                IngredientEntity(
                    1,
                    "Pasta"
                )
            ...
            assertThat(it[0].ingredients[1].ingredient, `is`(
                IngredientEntity(
                    2,
                    "Bolognese Sauce"
                )
            ...
            assertThat(it[1].ingredients[0].ingredient, `is`(
                IngredientEntity(
                    3,
                    "Rice"
                )
            ...
            assertThat(it[1].ingredients[1].ingredient, `is`(
                IngredientEntity(
                    4,
            ...
            assertThat(it[1].ingredients[2].ingredient, `is`(
                IngredientEntity(
                    5,
                    "Bell Pepper"
                )
    ...
    fun deleteJoinsFor() = runBlockingTest {
        ...
        digestDb.mealIngredientDao().getAllMealIngredientJoin().observeForever { joins ->
            val pastaJoin =
                MealIngredientEntity(1, 1)
            val bologneseJoin =
                MealIngredientEntity(1, 2)
